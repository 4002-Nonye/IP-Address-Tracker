...
const Results = () => {
  ...
  return (
    <div className="bg-white p-5 py-8 lg:py-0 z-10 w-9/12 lg:h-3/4 flex flex-col lg:flex-row rounded-lg text-center justify-between absolute top-48 drop-shadow-2xl items-center">
